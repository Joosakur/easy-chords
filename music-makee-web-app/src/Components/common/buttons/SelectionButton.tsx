...
const StyledButton = styled.button<StyledButtonProps>`
  ...
  box-shadow:
    1px 2px 1px ${p => shade(0.5, p.color)},
    1px 3px 5px 3px rgba(0, 0, 0, 0.6),
    inset 1px 1px 1px rgba(255, 255, 255, 0.3),
    inset 1px 3px 0.6rem rgba(255, 255, 255, 0.3);
  ...
  &:active, &.selected {
    ...
    box-shadow:
      1px 1px 0 ${p => shade(0.5, p.color)},
      1px 2px 1px 1px rgba(0, 0, 0, 0.15),
      inset 1px 1px 2px rgba(255, 255, 255, 0.1),
      inset 1px 2px 0.6rem rgba(255, 255, 255, 0.1);
    margin-top: 1px;
    margin-bottom: -1px;
  }
