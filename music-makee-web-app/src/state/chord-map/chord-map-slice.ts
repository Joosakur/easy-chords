...
export const selectActiveChordIndex = createSelector(selectChordMap, chordMap => chordMap.activeChordIndex)
export const selectIsChordButtonSelected = createSelector(selectChordMap, chordMap => chordMap.activeChordIndex !== null)
