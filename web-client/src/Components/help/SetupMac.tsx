...
export default function SetupMac(){
  return (
    <div>
      ...
      <p className="text-high">On macOS this is possible without any additional software, but you need to click through some settings to activate it.</p>
      <p className="text-high">First open an application called Audio MIDI Setup. From its Window menu select 'Show MIDI Studio' (1).</p>
      <CenteredDiv>
        <img src={imgMac1} alt="Screenshot" width="80%"/>
      </CenteredDiv>
      <Gap/>
      <p className="text-high">A new window opens. Double click the element which says 'IAC Driver' (2) and activate it by checking 'Device is online' (3).</p>
      <CenteredDiv>
