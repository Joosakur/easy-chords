    ...
    <div>
      ...
      <Splits>
        <SplitLeft>
          ...
          <p className="text-high">
            ...
            EasyChords Server to your DAW. EasyChords will output MIDI into this cable and your DAW
            can use it as a MIDI input as if it was any physical MIDI device.
          </p>
          <p className="text-high">
            One very easy and free software for that purpose is{' '}
            <a
          ...
          <p className="text-high">
            Download, install and run loopMIDI. Create a new MIDI port if not already done. You can
            name it as you wish. All default settings should work fine.
          </p>
        </SplitLeft>
        <SplitRight>
          <CenteredDiv>
      ...
      <Splits>
        <SplitLeft>
          ...
          <ul className="text-high">
            <li>
              Open up your favourite music software and create a MIDI / virtual instrument track.
            </li>
            <li>Make sure it's using the previously created virtual MIDI port as input.</li>
          </ul>
          <p className="text-high">
            <b>
              All done! Now you can play and record MIDI from EasyChords on your browser into your
              DAW!
            </b>
          </p>
        </SplitLeft>
